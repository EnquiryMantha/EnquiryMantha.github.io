...
const Home = () => {
    const maincontent = (
        <div className='maincontainer'>
            ...
            <button className='connectwithus'> <a style={{textDecoration:'none', color:'black'}} target="_blank" href="https://api.whatsapp.com/send/?phone=9763286926&text&type=phone_number">Connect With Us  <img style={{width:'40px'}} src="whatsapp.png" alt="" /></a></button>
        </div>
...
<br/><br/> <span style={{fontWeight:'600'}}>What set Mantha Services apart were its core principles:</span>                   
            ...
            <div className='ourteam'>
                ...
                <Card>
                    <Row>
                        <Col md={4} xs={12} style={{textAlign:'center'}}><img src="CA.jpg" alt="" /></Col>
                        <Col md={8} xs={12}> 
                ...
                <Card>
                    <Row>
                        <Col md={4} xs={12} style={{textAlign:'center'}}><img src="lawyer.png" alt="" /></Col>
                        <Col md={8} xs={12}> 
